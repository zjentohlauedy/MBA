...
describe PlayerService do
  ...
  describe '#get_player' do
    ...
    it 'should call the repository to get the pitcher record from the database if the player type is pitcher' do
      player = {player_id: 1, first_name: 'Firstname1', last_name: 'Lastname1', first_phoenetic: 'FN1', last_phoenetic: 'LN1', skin_tone: 1, handedness: 3, player_type: PlayerTypes::Pitcher, rookie_season: 5, longevity: 7}
    ...
    it 'should call the response mapper with the player record from the repository if player type is not batter nor pitcher' do
      player = {player_id: 1, first_name: 'Firstname1', last_name: 'Lastname1', first_phoenetic: 'FN1', last_phoenetic: 'LN1', skin_tone: 1, handedness: 3, player_type: PlayerTypes::None, rookie_season: 5, longevity: 7}
