...
describe PlayerService do
  ...
  describe '#get_player' do
    ...
    it 'should call the repository to get the pitcher record from the database if the player type is pitcher' do
      player = {player_id: 1, first_name: 'Firstname1', last_name: 'Lastname1', first_phoenetic: 'FN1', last_phoenetic: 'LN1', skin_tone: SkinTones::Light, handedness: Handedness::Switch, player_type: PlayerTypes::Pitcher, rookie_season: 5, longevity: 7, retired_season: 15}
    ...
    it 'should call the response mapper with the player record from the repository if player type is not batter nor pitcher' do
      player = {player_id: 1, first_name: 'Firstname1', last_name: 'Lastname1', first_phoenetic: 'FN1', last_phoenetic: 'LN1', skin_tone: SkinTones::Light, handedness: Handedness::Switch, player_type: PlayerTypes::None, rookie_season: 5, longevity: 7, retired_season: 15}
    ...
    it 'should call the decorator with the mapped player record if player type is not batter nor pitcher' do
      player = {player_id: 1, first_name: 'Firstname1', last_name: 'Lastname1', first_phoenetic: 'FN1', last_phoenetic: 'LN1', skin_tone: SkinTones::Light, handedness: Handedness::Switch, player_type: PlayerTypes::None, rookie_season: 5, longevity: 7, retired_season: 15}
      mapped_player = {player_id: 1, first_name: 'Firstname1', last_name: 'Lastname1', first_phoenetic: 'FN1', last_phoenetic: 'LN1', skin_tone: 'Light', handedness: 'Switch', player_type: 'Unknown', rookie_season: 5, longevity: 7, retired_season: 15}
    ...
    it 'should call the decorator with the mapped player record if player type is pitcher' do
      player = {player_id: 1, first_name: 'Firstname1', last_name: 'Lastname1', first_phoenetic: 'FN1', last_phoenetic: 'LN1', skin_tone: SkinTones::Light, handedness: Handedness::Switch, player_type: PlayerTypes::Pitcher, rookie_season: 5, longevity: 7, retired_season: 15}
      mapped_player = {player_id: 1, first_name: 'Firstname1', last_name: 'Lastname1', first_phoenetic: 'FN1', last_phoenetic: 'LN1', skin_tone: 'Light', handedness: 'Switch', player_type: 'Pitcher', rookie_season: 5, longevity: 7, retired_season: 15, speed: 4, control: 6, bunt: 2, fatigue: 7}
    ...
    it 'should return the mapped, decorated database record if player type is not batter nor pitcher' do
      player = {player_id: 1, first_name: 'Firstname1', last_name: 'Lastname1', first_phoenetic: 'FN1', last_phoenetic: 'LN1', skin_tone: SkinTones::Light, handedness: Handedness::Switch, player_type: PlayerTypes::None, rookie_season: 5, longevity: 7, retired_season: 15}
      mapped_decorated_player = {player_id: 1, first_name: 'Firstname1', last_name: 'Lastname1', first_phoenetic: 'FN1', last_phoenetic: 'LN1', skin_tone: 'Light', handedness: 'Switch', player_type: 'Unknown', rookie_season: 5, longevity: 7, retired_season: 15, _links: {}}
    ...
    it 'should return the mapped, decorated database record if player type is pitcher' do
      player = {player_id: 1, first_name: 'Firstname1', last_name: 'Lastname1', first_phoenetic: 'FN1', last_phoenetic: 'LN1', skin_tone: SkinTones::Light, handedness: Handedness::Switch, player_type: PlayerTypes::Pitcher, rookie_season: 5, longevity: 7, retired_season: 15}
      mapped_decorated_player = {player_id: 1, first_name: 'Firstname1', last_name: 'Lastname1', first_phoenetic: 'FN1', last_phoenetic: 'LN1', skin_tone: 'Light', handedness: 'Switch', player_type: 'Pitcher', rookie_season: 5, longevity: 7, retired_season: 15, _links: {}}
    ...
    it 'should return the mapped, decorated database record if player type is batter' do
      player = {player_id: 1, first_name: 'Firstname1', last_name: 'Lastname1', first_phoenetic: 'FN1', last_phoenetic: 'LN1', skin_tone: SkinTones::Light, handedness: Handedness::Switch, player_type: PlayerTypes::Batter, rookie_season: 5, longevity: 7, retired_season: 15}
      mapped_decorated_player = {player_id: 1, first_name: 'Firstname1', last_name: 'Lastname1', first_phoenetic: 'FN1', last_phoenetic: 'LN1', skin_tone: 'Light', handedness: 'Switch', player_type: 'Batter', rookie_season: 5, longevity: 7, retired_season: 15, _links: {}}
    ...
    it 'should pass season and phase parameters to the decorator if player type is pitcher' do
      player = {player_id: 1, first_name: 'Firstname1', last_name: 'Lastname1', first_phoenetic: 'FN1', last_phoenetic: 'LN1', skin_tone: SkinTones::Light, handedness: Handedness::Switch, player_type: PlayerTypes::Pitcher, rookie_season: 5, longevity: 7, retired_season: 15}
      mapped_player = {player_id: 1, first_name: 'Firstname1', last_name: 'Lastname1', first_phoenetic: 'FN1', last_phoenetic: 'LN1', skin_tone: 'Light', handedness: 'Switch', player_type: 'Pitcher', rookie_season: 5, longevity: 7, retired_season: 15}
    ...
    it 'should pass season and phase parameters to the decorator if player type is batter' do
      player = {player_id: 1, first_name: 'Firstname1', last_name: 'Lastname1', first_phoenetic: 'FN1', last_phoenetic: 'LN1', skin_tone: SkinTones::Light, handedness: Handedness::Switch, player_type: PlayerTypes::Batter, rookie_season: 5, longevity: 7, retired_season: 15}
      mapped_player = {player_id: 1, first_name: 'Firstname1', last_name: 'Lastname1', first_phoenetic: 'FN1', last_phoenetic: 'LN1', skin_tone: 'Light', handedness: 'Switch', player_type: 'Batter', rookie_season: 5, longevity: 7, retired_season: 15}
