...
AccoladeLookups = [
  ...
  { accolade: Accolades::Pitching::Most_Wins,                    method: :get_starting_pitcher_stats_by_highest,  stat: 'wins',              phase: Phases::RegularSeason },
  { accolade: Accolades::Pitching::Best_Win_Loss_Ratio,          method: :get_starting_pitcher_stats_by_highest,  stat: 'win_loss_ratio',    phase: Phases::RegularSeason },
  { accolade: Accolades::Pitching::Best_Win_Percentage,          method: :get_starting_pitcher_stats_by_highest,  stat: 'win_pct',           phase: Phases::RegularSeason },
  { accolade: Accolades::Pitching::Best_Earned_Run_Average,      method: :get_starting_pitcher_stats_by_lowest,   stat: 'earned_run_avg',    phase: Phases::RegularSeason },
  { accolade: Accolades::Pitching::Best_vs_Batting_Average,      method: :get_starting_pitcher_stats_by_lowest,   stat: 'vs_batting_avg',    phase: Phases::RegularSeason },
  { accolade: Accolades::Pitching::Most_Saves,                   method: :get_starting_pitcher_stats_by_highest,  stat: 'saves',             phase: Phases::RegularSeason },
  { accolade: Accolades::Pitching::Most_Strike_Outs,             method: :get_starting_pitcher_stats_by_highest,  stat: 'strike_outs',       phase: Phases::RegularSeason },
  { accolade: Accolades::Pitching::Most_Innings_per_Game,        method: :get_starting_pitcher_stats_by_highest,  stat: 'innings_per_game',  phase: Phases::RegularSeason },
  { accolade: Accolades::Pitching::Best_Walks_Hits_Per_Inning,   method: :get_starting_pitcher_stats_by_lowest,   stat: 'whip',              phase: Phases::RegularSeason },
